...
# React + TypeScript + Vite + React Router v7 declarative mode

This template provides a minimal setup to get React working in Vite with HMR, react router v7, and some ESLint rules.
